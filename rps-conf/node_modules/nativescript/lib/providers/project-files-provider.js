...
class ProjectFilesProvider extends project_files_provider_base_1.ProjectFilesProviderBase {
    constructor($platformsData, $projectData, $mobileHelper, $options) {
    ...
    mapFilePath(filePath, platform) {
        ...
        if (parsedFilePath.indexOf(platformSpecificAppResourcesDirectoryPath) > -1) {
            let appResourcesRelativePath = path.relative(path.join(this.$projectData.projectDir, constants.APP_FOLDER_NAME, constants.APP_RESOURCES_FOLDER_NAME, platformData.normalizedPlatformName), parsedFilePath);
