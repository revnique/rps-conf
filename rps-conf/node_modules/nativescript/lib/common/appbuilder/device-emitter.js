...
class DeviceEmitter extends events_1.EventEmitter {
    constructor($androidDeviceDiscovery, $iOSDeviceDiscovery, $iOSSimulatorDiscovery, $devicesService, $deviceLogProvider, $companionAppsService, $projectConstants, $logger) {
        super();
